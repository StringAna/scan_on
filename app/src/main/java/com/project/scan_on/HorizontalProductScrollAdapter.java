...
public class HorizontalProductScrollAdapter extends RecyclerView.Adapter<HorizontalProductScrollAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HorizontalProductScrollAdapter.ViewHolder viewHolder, int position) {
            ...
            String title = horizontalProductScrollModelList.get(position).getProductTittle();
            String description = horizontalProductScrollModelList.get(position).getProductDescription();
            String price = horizontalProductScrollModelList.get(position).getProductPrice();

            viewHolder.setProductImage(resource);
            viewHolder.setProductTittle(title);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            productTittle = itemView.findViewById(R.id.h_s_product_title);
        ...
        private void setProductTittle(String title){
            productTittle.setText(title);
        }
