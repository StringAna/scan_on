...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, String productTitle, int freeCoupons, String cuttedPrice, String productPrice, int productQuantity, int offersApplied, int couponsApplied) {
        this.type = type;
